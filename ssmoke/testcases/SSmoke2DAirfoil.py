...
region[:,0:6] = True
region[:,-6:0] = True
constraint_inlet = VelocityConstraint2D((Nx, Ny), (1.0, 0.0), region)

integrator = SSmoke2D((Nx, Ny), (dx, dy), hbar, periodic=False, initValues=initial_vel_field,
                      constraints=(constraint_airfoil, constraint_inlet))
...
print('Saving data...')
save_2d('prerendered\\SSmoke2DAirfoil.data', Nframes, (Nx, Ny), (dx, dy), times, xcoords, ycoords, vx, vy)
